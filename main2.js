	...
	function goodTube_iframe_addCustomButtons() {
		...
		if (theaterButton) {
			...
			theaterButton.innerHTML = `
				<svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%">
					...
					<path d="m 28,11 0,14 -20,0 0,-14 z m -18,2 16,0 0,10 -16,0 0,-10 z" fill="#fff" fill-rule="evenodd" id="ytp-id-30"></path>
				</svg>
			`;
		...
		if (subtitlesButton) {
			...
			subtitlesButton.insertAdjacentHTML('beforebegin', `
				<button class="ytp-button ytp-autonav-toggle" id="goodTube_autoplayButton">
					<div class="ytp-autonav-toggle-button-container">
						<div class="ytp-autonav-toggle-button" aria-checked="' + goodTube_getParams['goodTube_autoplay'] + '"></div>
					</div>
				</button>`
			);
